...
![Topología de la red de YouTubers Argentinos (2012-2016). Los nodos están ponderados por su grado (cantidad de colaboraciones). La red exhibe una estructura de "archipiélago" con comunidades altamente cohesionadas pero escasamente conectadas entre sí.](imagenes/viz_red_nodos_grado.png){#fig-redes-ars fig-align="center" width="85%"}
...
: Métricas de red por youtuber. PageRank: calidad de conexiones. Betweenness: capacidad de intermediación. Hub Score: rol como conector. Grado (In/Out): colaboraciones recibidas/emitidas. Fuente: ARS sobre corpus nuclear (24 nodos, 48 aristas). {#tbl-metricas-red}
...
## Trayectorias identitarias individuales

Si el análisis de redes ofreció la topografía del campo, el estudio de casos permite descender a la experiencia del caminante. A continuación reconstruimos las trayectorias de los ocho creadores nucleares del corpus, integrando sus coordenadas biográficas, su posición en la red y la materialidad multimodal de su performance. Lejos de ser perfiles estáticos, estos casos ilustran cómo los índices abstractos (IGL, ICP, IAP) se encarnan en gestos, espacios y decisiones de montaje específicos.

### Lucas Castel: la estética del desborde y la autenticidad barrial
...
::: {#fig-castel-trayectoria layout-ncol=2}
![Estilo amateur temprano (2012)](capturas/cap06_c03a_castel_temprano.png){#fig-castel-temprano}

![Producción profesionalizada (2016)](capturas/cap06_c03b_castel_tardio.png){#fig-castel-tardio}

Trayectoria y profesionalización: contraste entre el estilo amateur temprano en el dormitorio de San Justo y la producción sofisticada en viajes internacionales (Lucas Castel).
:::


### Julián Serrano: la proxémica de la seducción y el cuerpo como capital
...
![Ego network de Julián Serrano generada en Gephi. Ilustra la posición central del youtuber en la red de colaboraciones y su altísima centralidad de intermediación.](imagenes/cap06_c01_ego_serrano.png){#fig-ego-serrano fig-align="center" width="85%"}


### Mica Suárez: la intimidad del cuarto propio y la resistencia estética
...
![La "estética del cuarto propio": Mica Suárez en su dormitorio, despojada de maquillaje y artificios, construyendo una autenticidad horizontal basada en la confidencia.](capturas/cap01_c01_setup_dormitorio.png){#fig-mica-cuarto fig-align="center" width="85%"}

![Ego-network de Mica Suárez: se observa su rol como puente en la Red de Lifestyle y su alta densidad de conexiones locales, consolidándola como el nodo de confianza del sistema.](imagenes/viz_ego_network_mica.png){#fig-ego-mica fig-align="center" width="85%"}


### Lionel Ferro: el cuerpo disciplinado y la asepsia transnacional
...
### Gonzalo Goette: el cuerpo en riesgo y la autenticidad del conflicto
...
### Mariano Bondar: la estética del contraste y la inestabilidad como verdad
...
![Trayectoria y maduración discursiva: Mariano Bondar reaccionando a su propio "pasado oscuro". El contraste entre el frame del video temprano (confrontativo/amateur) y la reacción tardía (reflexiva/profesionalizada) ilustra el ciclo vital del creador en la plataforma.](capturas/cap06_c05a_bondar.png){#fig-bondar-trayectoria fig-align="center" width="85%"}

::: {.content-visible when-format="html"}
[▶ Ver este video en YouTube](https://youtu.be/nIKmziznnT4?si=Lhfy4NvaSjd3g_pG){target="_blank"}
:::

### Gonzalo Fonseca: la ética del low-fi y la resistencia local
...
Si Ferro representa la aspiración global, Gonzalo Fonseca encarna la resistencia de la localidad. Su IGL más bajo de todo el corpus (-1.16) marca una identidad territorializada al extremo: rechaza la neutralización dialectal, sus temas y referencias son obstinadamente argentinos, construyendo una comunidad de sentido anclada en la experiencia barrial compartida.
...
### Elchuiuical (Julián Iurchuk): la estética del desborde y el glitch identitario
...
![La estética del absurdo y el "glitch" identitario: el uso de la performance exagerada y el escenario del dormitorio como laboratorio creativo (Elchuiucal, 2016).](capturas/cap06_c02_elchuiucal_absurdo.png){#fig-elchuiucal-absurdo fig-align="center" width="85%"}

::: {.content-visible when-format="html"}
[▶ Ver este momento en YouTube](https://youtu.be/DMCd6nL-E6U?si=yudLoiD9W9K5KrVm&t=5){target="_blank"}
:::
...
### Trayectorias de género

El género opera como variable moduladora decisiva. El corpus evidencia una pluralidad de masculinidades que rompe con el modelo monolítico: conviven la masculinidad popular-barrial (Castel), la seductora-ambigua (Serrano), la sensible-vulnerable (Bondar) y la profesional-neutra (Ferro). Esta diversidad sugiere que YouTube funcionó, en este período, como un laboratorio para experimentar con identidades masculinas que integran la afectividad y la exposición corporal de modos inéditos.
...
## Síntesis: el videoblog como laboratorio de identidades

El análisis transversal de las trayectorias revela que el videoblog juvenil argentino opera como un laboratorio de experimentación procesual. Los youtubers analizados no solo "muestran quiénes son" ante la cámara; construyen y devienen quiénes son a través de la práctica iterativa y sostenida del vlogging, fuertemente marcada por la retroalimentación del público. La identidad aquí no es un punto de partida, sino un efecto performativo de la navegación en la plataforma.

### La identidad como ensamblaje validado métricamente

Las trayectorias analizadas demuestran que las "identidades YouTuber" no son esencias monolíticas, sino ensamblajes complejos y situados: se configuran mediante la articulación inestable de recursos semióticos (dialectos, vestuarios, músicas, poéticas del espacio), estrategias discursivas (registros, modos de interpelación), posicionamientos relacionales en el sistema de alianzas, retroalimentaciones algorítmicas (métricas, monetización) y reacciones de la comunidad.
...
### El montaje situado en un espacio social practicado

Las trayectorias confirman que la identidad en YouTube opera como un montaje situado: una composición deliberada, pero flexible de elementos heterogéneos que responde a un campo de presiones múltiples y contradictorias. El youtuber debe parecer "real" mientras construye un personaje performático; mantener la especificidad cultural local mientras busca el alcance transnacional; y exponer la intimidad personal mientras gestiona profesionalmente lo comercial.

El éxito en la plataforma no deriva de resolver o anular estas contradicciones, sino de navegarlas productivamente. Los creadores con trayectorias más sostenidas del corpus no son los más coherentes, sino los que mejor gestionan la incoherencia, transformando las fricciones identitarias en recursos creativos. Esta dinámica valida la noción de YouTube como un espacio social practicado [@mayans2002]: no es una mera infraestructura técnica neutra, sino un territorio denso donde las prácticas juveniles de construcción subjetiva adquieren formas específicas, mediadas, pero nunca determinadas mecánicamente por las affordances tecnológicas y las lógicas algorítmicas.

![Síntesis analítica: el videoblog como laboratorio de identidades. El esquema ilustra la tensión entre las demandas del algoritmo, las búsquedas expresivas del sujeto y las validaciones de la comunidad.](imagenes/diag_sintesis_laboratorio.png){#fig-sintesis-lab fig-align="center" width="90%"}
...
### La economía política de la afectividad

La integración del análisis multimodal y métrico confirma que la identidad digital no es una abstracción discursiva, sino una performance materialmente anclada y estadísticamente validada. La correlación positiva fuerte ($r = 0.726$) entre extimidad y cercanía parasocial revela que la intimidad no es un desborde ingenuo, sino una inversión racional: la apertura del espacio privado es la moneda de cambio para la construcción de vínculos afectivos.
...
En última instancia, las trayectorias analizadas ilustran la emergencia de una nueva forma de subjetividad juvenil marcada por lo que podríamos llamar el emprendedurismo de sí. Los sujetos de este estudio no solo narraron su adolescencia; la gestionaron como una carrera. La evolución desde el amateurismo lúdico hacia la profesionalización estratégica no es una traición a la esencia del género, sino su maduración inevitable.

El trazado longitudinal de la extroversión demuestra que la identidad es un devenir algorítmicamente mediado, donde la crisis y la reformulación no son anomalías, sino etapas constitutivas del ciclo vital en la plataforma. Estos jóvenes demostraron una sofisticada capacidad agencial para navegar las contradicciones de un sistema que exige, paradójicamente, ser espontáneo bajo un guion industrial y ser íntimo a escala global. Estudiar sus trayectorias es comprender cómo se reescriben las reglas de la legitimidad social cuando el "Yo" se convierte en la principal mercancía y la red en el territorio donde esa mercancía debe circular para existir.

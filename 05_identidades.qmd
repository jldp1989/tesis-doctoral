# Identidades juveniles digitales: representaciones, narrativas y subjetividades en el videoblog
...
El concepto de representaciones sociales (RS), formulado por @moscovici1979, constituye un punto de partida conceptual productivo para comprender cómo los sujetos construyen conocimiento de sentido común. Moscovici definió una representación social como "una modalidad particular de conocimiento cuya función es la elaboración de los comportamientos y la comunicación entre los individuos" (p. 17-18). Las RS funcionan como marcos interpretativos compartidos que hacen posible la vida social al proveer códigos comunes de significación; operan mediante dos procesos: la *objetivación*, que otorga textura material a nociones abstractas, y el *anclaje*, que integra lo nuevo en un sistema de conocimiento preexistente [@jodelet1986].

Para nuestro análisis del ciberdiscurso juvenil resulta particularmente productiva la articulación que propone @raiter2002 entre representaciones sociales y representaciones discursivas. Las RS tienen una dimensión cognitiva, pero solo podemos acceder a ellas a través de sus materializaciones discursivas: en el caso de los videoblogs, las representaciones sobre juventud no simplemente "se expresan" en los videos, sino que se construyen performativamente en cada enunciación. En este desplazamiento desde la RS a la Representación Discursiva (RD), seguimos a @montecinosoto2005, quien las define como las "imágenes-creencias" que los hablantes construyen lingüísticamente en contextos concretos mediante recursos léxicos, semánticos y sintácticos.

### La presentación del *self*

La teoría dramatúrgica de @goffman1959 ofrece herramientas centrales para comprender las dinámicas identitarias en el vlog. Los conceptos son conocidos, pero vale la pena precisar cómo operan en el medio digital.

El *frontstage* en el videoblog incluye el escenario de grabación, la apariencia, y los modales del youtuber frente a la cámara. La distinción entre *frontstage* y *backstage* se complejiza porque los youtubers graban frecuentemente en espacios privados —el dormitorio como espacio *backstage* por excelencia— y exhiben deliberadamente elementos de esa región posterior como estrategia de autenticidad. La edición permite controlar qué del backstage se revela, lo que genera lo que podríamos llamar un *backstage curado*: la exhibición de lo supuestamente espontáneo es, ella misma, un trabajo de producción.

Esta lógica conecta directamente con lo que @sibilia2008 denominó *extimidad*: la exhibición estratégica de la intimidad como forma de construcción del yo en entornos de alta visibilidad. Ver un videoblog confesional no es leer el diario ajeno: es estar sentado en la habitación de alguien mientras te cuenta sus secretos mirándote a los ojos. Sin embargo, esos ojos están mirando a una cámara, y ese cuarto fue elegido, preparado, iluminado. La asimetría técnica del medio no destruye el efecto emocional de la extimidad —lo hace posible. La aplicación de Goffman al entorno digital requiere considerar las especificidades del medium: asincronía (que permite edición y control), escalabilidad (audiencia potencialmente masiva), persistencia (archivo de actuaciones) y replicabilidad (videos compartidos y resignificados).

### Culturas juveniles y los "entre" generacionales

El concepto de culturas juveniles, desarrollado por @feixa1998 y @feixa2014, resulta fundamental para comprender las identidades que se construyen en el videoblog. Feixa define las culturas juveniles como "el conjunto de formas de vida y valores, expresados por colectivos generacionales en respuesta a sus condiciones de existencia social y material" (1998, p. 60). Esta definición enfatiza que lo juvenil no es una categoría biológica, sino una construcción sociocultural históricamente situada.

Para el análisis específico de nuestro corpus resultan particularmente productivos los aportes de @bernete2007, quien considera que las culturas juveniles de la primera década del siglo XXI "habitan el 'entre'". Identifica cinco: entre la pertenencia a la cultura global y el refugio en las culturas locales; entre la vinculación a otros jóvenes y la reproducción del mundo adulto; entre la comunicación de masas y la comunicación en red; entre el mandato de obedecer y el mandato de distinguirse; entre la escuela obligatoria y la escuela desbordada.

Estos "entre" no son tensiones abstractas, sino coordenadas estructurales que se materializan en prácticas discursivas concretas. Cuando Lucas Castel hace un video de Halloween usando un formato global, pero explicando que "en Argentina la gente mayor no tiene idea de lo que es Halloween" (VID 1), está habitando productivamente el entre global/local. Cuando Julián Serrano construye su identidad rebelde, pero simultáneamente apela a experiencias compartidas con su audiencia joven, está negociando entre distinguirse y pertenecer. A su vez, @bernete2007 señala que Internet ha recuperado la palabra, pero que los jóvenes siguieron decantando por opciones más emotivas: el vlog "ha traído a la blogsfera la experiencia no verbal: intercambio de imágenes, fijas o en movimiento, con sonido o sin él, pero sin texto que cuente algo, haciendo que el sentido dependa mucho más de quien lo recibe y sus circunstancias" (p. 69). Lo que nos importa de este señalamiento es que el vlog no resuelve los "entre" sino que los convierte en materia prima narrativa.

El diseño de nuestra matriz de análisis operacionalizó estos planteos teóricos mediante pares de oposición que permitieron registrar cómo las identidades juveniles se discursivan en la tensión entre polos aparentemente contradictorios: Global/Local, Mundo joven/Mundo adulto, Comunicación en redes/Comunicación en masas, Obedecer/Distinguirse. Como señala @garciacanclini1989 en su conceptualización de las culturas híbridas, no se trata de procesos de sustitución, sino de entrecruzamiento.
...
![Modelo analítico integrado: tres niveles de análisis de las identidades juveniles digitales. El videoblog actúa como arena de negociación entre representaciones, subjetividades e identidades.](imagenes/viz19_modelo_niveles.png){#fig-modelo-niveles fig-align="center" width="95%"}
...
## Representaciones sociales de juventud en el corpus

Esta sección examina las representaciones sobre juventud que circulan, se reproducen y se negocian en los videoblogs del corpus. Como señala @palazzo2010b, el ciberdiscurso juvenil no solo refleja representaciones preexistentes, sino que las construye, las actualiza y las pone en tensión mediante prácticas discursivas específicas.

Para identificar las representaciones operantes en el corpus se aplicó un enfoque mixto. El análisis temático de las matrices de codificación relevó sistemáticamente los 80 videos identificando patrones relacionados con construcciones identitarias. Las variables más directamente vinculadas a representaciones de juventud son: "Identidad y subjetividad" (45/80 videos = 56.25%), "Extimidad e intimidad compartida" (32/80 = 40%), "Familia y vínculos afectivos" (28/80 = 35%), "Amor, pareja y sexualidad" (24/80 = 30%), "Glocalidad y referencias culturales" (48/80 = 60%). El análisis léxico-semántico de las 80 transcripciones disponibles identificó campos semánticos recurrentes. La codificación siguió criterios binarios (presencia/ausencia) para cada video; las categorías no son mutuamente excluyentes, permitiendo co-ocurrencias que revelan articulaciones complejas. Los índices ponderados que se presentan más adelante complementan este análisis binario al capturar gradaciones e intensidades.

### Representaciones hegemónicas

Del análisis emergen cuatro grandes representaciones sobre juventud que estructuran las narrativas identitarias de los youtubers argentinos.

#### Los jóvenes como residentes digitales creativos

Un 68% de los videos contienen referencias a competencias digitales o creatividad mediática. Esta representación se caracteriza por la naturalización del manejo tecnológico, la creatividad como valor diferenciador generacional, y el emprendedurismo digital como alternativa laboral legítima.

El ejemplo paradigmático es el video "VLOG VIAJE SECRETO A LONDRES" de Lucas Castel (VID 10). Al narrar su viaje a las instalaciones de YouTube en Londres, donde fue seleccionado por la plataforma entre creadores de contenido, dice:

> "Me llegó una noticia de YouTube, me eligieron para ir a Londres. La verdad que Londres es un lugar hermoso, es un lugar que siempre quise conocer. Y ahora se me dio la oportunidad, así que bueno, gracias a ustedes que me apoyan, a YouTube que me eligió por alguna razón, así que estoy muy feliz." (0:17-0:30)

La frase "YouTube me eligió" construye una narrativa meritocrática donde la plataforma reconoce y premia el talento creativo juvenil. El viaje a Londres funciona como validación institucional de su estatus de creador. Significativamente, Lucas no presenta esto como logro excepcional, sino como consecuencia natural de su trayectoria, naturalizando la figura del youtuber como profesional legítimo.

Gonzalo Fonseca introduce un matiz reflexivo al documentar la recepción del "botón de plata" en "BOTÓN DE PLATA Y EL #ClubMediaFest" (VID 27):

> "Es por haber pasado los 100.000 suscriptores. Tipo, ya voy por los 300.000, ¿no? Pero YouTube es medio lento. Estoy zarpado que te manden estas cosas. [...] Nada más quería mostrarles, porque esto lo logré gracias a ustedes." (0:07-0:31)

Y más adelante, al describir el evento presencial:

> "Si aún no se da cuenta de la magnitud de gente que te ve hasta que ves a toda esa gente ahí... ¡La puta madre! ¡30.000 personas, papá!" (1:25-1:42)

El botón de plata funciona como objeto-fetiche que materializa el reconocimiento institucional; la expresión "cumplir todos mis sueños" explicita la narrativa aspiracional que subyace a esta representación.

Sin embargo, la representación del "joven creador digital" no es unívoca. Elchuiuical (VID 63) introduce la tensión entre el crecimiento del canal y la expectativa de cercanía comunitaria:

> "También me molesta que mucha gente diga que cambié de corazón. [...] No puedo responder los comentarios que respondía cuando tenía 5.000." (1:53-2:05)

Al defender la legitimidad de una gestión profesionalizada que no puede mantener las mismas prácticas de cuando el canal era pequeño, Elchuiuical demuestra que la representación está atravesada por una demanda contradictoria: el creador debe ser a la vez profesional y cercano.

#### La juventud como momento de libertad y experimentación

Un 72% de los videos incluyen narrativas de libertad, rebeldía o experimentación. La reivindicación del derecho a equivocarse, la exploración identitaria como proceso legítimo y la tensión con las expectativas adultas caracterizan esta representación.

Julián Serrano la despliega en "FILOSOFANDO (?)" (VID 11) con una complejidad irónica que merece atención:

> "Antes hacía videos, lo hacía porque estaba re al pedo en la secundaria y no hacía nada, ahora hago algo y la verdad que no estoy tan al pedo como a mí me gustaría estar, así que decidí una cosa, y esta, presta atención que es muy buena y yo sé que yo tengo mucha llegada al público joven de Argentina, soy como un ejemplo a seguir, aunque sea la peor mierda para seguir, me tomás como un ejemplo, lo cual me parece pésimo, pero bueno, ahí va, dejo la facultad." (0:48-1:08)

El fragmento es notable en varios niveles. Serrano se posiciona simultáneamente como "ejemplo a seguir" y como "la peor mierda para seguir", desactivando la autoridad que él mismo construye. La decisión de dejar la facultad, sancionada negativamente por la lógica adulta, se presente como acto de autonomía. El título interrogativo "FILOSOFANDO (?)" refuerza la distancia irónica: la reflexión existencial se presenta como juego. En contraste, en "NUNCA TE RINDAS" (VID 15) Serrano adopta un registro claramente motivacional:

> "¿O querés ser uno más? ¿Querés ser otra estadística del número de personas que no hicieron lo que querían por el miedo a qué dirán, que no caminan por miedo a que los perros ladren?" (1:02-1:10)

La metáfora de "los perros que ladran" codifica a los críticos como adultos o instituciones que intentan detener la autorrealización juvenil.

Una versión más cotidiana y menos épica de esta representación aparece en Mica Suárez (VID 71, "15 COSAS QUE ODIO"), donde la autonomía se construye en el terreno de lo doméstico y lo estético:

> "Odio a las personas materialistas. [...] A mí me pasó mucho con estos auriculares. Sí, son una mierda. Simulan ser Beats, pero obviamente no son originales. No se imaginan la cantidad de personas que me cargaron por tener estos auriculares." (1:24-1:46)

Mica reivindica el derecho a usar auriculares "truchos" sin vergüenza. Esta rebeldía menor, cotidiana y "no épica", es característica del registro de varios youtubers del corpus, donde la autonomía se articula desde lo estético más que desde grandes gestos de ruptura.

#### El youtuber como trabajo legítimo

Un 45% de los videos incluyen referencias a YouTube como trabajo o profesión. La defensa frente a críticas adultas, la profesionalización de la práctica y la construcción de autoridad desde competencias digitales caracterizan esta representación.

Lucas Castel la articula de manera paradigmática en "EL MEJOR AÑO DE MI VIDA" (VID 6):

> "Por más que vos digas que soy un virgen que está solo en una habitación hablándole a una cámara, no es así. Porque no le estoy hablando a una cámara, le estoy hablando a ustedes. A los que están ahí mirándome." (0:33-0:45)

Al reformular la actividad de producción solitaria de contenido como práctica comunicativa relacional, Lucas transforma la imagen del youtuber solitario en productor de comunidad. Y más adelante en el mismo video, narra la génesis de esa práctica con una transparencia que ilumina la lógica del oficio:

> "Hace tiempo cuando yo empecé a hacer videos, me acuerdo que mis amigos y los pocos que me miraban me decían que lo que hacía estaba bueno y que lo siga haciendo. Yo dije, bueno, está bien, si les gusta y le alegro el día a alguien, ¿por qué no? Lo sigo haciendo. Seguí haciendo videos, seguí cagándome de risa y bueno, el tiempo fue pasando hasta que pasó." (VID 6, 0:09-0:20)

El relato es significativo: la motivación no es la fama ni el dinero, sino el reconocimiento de los pares y la posibilidad de "alegrar el día a alguien". La frase final —"el tiempo fue pasando hasta que pasó"— naturaliza el crecimiento del canal como algo que simplemente *ocurrió*, no como un proyecto estratégico. La anticipación y refutación de la crítica ("vas a ser un agrandado") evidencia la conciencia de que esta representación se construye activamente, no se da por sentada.

#### Autenticidad

Un 82% de los videos incluyen marcadores de autenticidad, convirtiendo a ésta en la representación más extendida del corpus. El imperativo de "ser uno mismo", la transparencia emocional como prueba de genuinidad y el rechazo a la hipocresía la caracterizan.

El formato "50 cosas sobre mí" funciona como tecnología de autenticidad. Lucas Castel lo establece desde el comienzo (VID 5): "Así me conocerán un poquito más y saben quién carajo soy, ¿no?" La expresión es deliberadamente zafada, pero también directa: la autenticidad se produce revelando información personal que construye familiaridad.

Sin embargo, lo que se revela es cuidadosamente calibrado. Después de contar que come budín mientras se baña (excentricidad menor que construye autenticidad mediante la absurdidad), señala: "Tuve solamente una novia y estoy soltero hace rato. Y la verdad se vive muy bien así, papá" (1:20-1:26). El comentario jocoso inmediatamente deflecta el potencial dramatismo del tema. Esta oscilación entre revelación e ironía es característica del estilo de Lucas: permite intimidad calibrada sin exposición excesiva.

Mica Suárez despliega una versión de autenticidad específicamente generizada en VID 74: "Casi nunca me maquillo. Prefiero estar diez mil veces así, al natural, y que me vean así como soy. Sin filtro." Y agrega: "Cuando era chica me hacían mucho bullying. Demasiado. Vivía en una provincia y me insultaban mucho por ser de Buenos Aires. O sea, por ser porteña. Pero bueno, son cosas que pasan. Y me pasan a mí sola." El "sin filtro" opera en doble sentido: literal (sin maquillaje) y metafórico (sin censura). La frase final —"son cosas que pasan, y me pasan a mí sola"— combina resignación con reivindicación de singularidad: su experiencia es a la vez universal y única.

Elchuiuical (VID 68) construye autenticidad mediante la acumulación de detalles ordinarios y el humor autodeprecativo: "Vivo en Bahía Blanca, que es una ciudad al sur de la provincia de Buenos Aires. Y es una ciudad, no es un pueblo. No inventen que es un pueblo porque viven como 400.000 personas. No hay vacas, hay wifi." Y sobre ser prematuro: "Por eso que soy tan retrasado." Su autenticidad reside en no tomarse en serio, en la negativa a construir una imagen heroica.

Como argumenta @marwick2013, la autenticidad en redes sociales no consiste en la ausencia de performance, sino en la capacidad de construir performances que sean percibidas como genuinas. La autenticidad digital es una autenticidad performada, pero no por ello menos real en sus efectos identitarios y comunitarios.

### Representaciones emergentes y contra-hegemónicas

Junto a las representaciones dominantes, el corpus evidencia representaciones que cuestionan o complejizan las visiones hegemónicas. No son marginales: aparecen de manera consistente en aproximadamente un tercio del corpus.

#### La juventud vulnerable

Un 28% de los videos incluyen referencias explícitas a vulnerabilidad, ansiedad o problemas emocionales. Mariano Bondar es el caso más representativo. En "COMO SUPERÉ LA MUERTE DE MI AMIGO" (VID 50) abre así:

> "Hace mucho tiempo que tengo ganas de hacer este video y bueno, recientemente no me he estado sintiendo muy bien y bueno, como siempre tengo la cámara como para poder descargarme. No tengo idea cuándo subir este video, no tengo idea siquiera si voy a avisar que voy a subir este video, pero es algo que tengo muchas ganas de compartir hace tiempo." (0:08-0:35)

La incertidumbre sobre la publicación es significativa: rompe la lógica de producción regular del youtuber y marca que este contenido excede las categorías habituales. La referencia a la cámara como herramienta de descarga emocional explicita una función del videoblog que usualmente permanece implícita. En el mismo video, describe las consecuencias psicológicas de la pérdida de su amigo:

> "Después de eso creo que vino una de las peores partes de mi adolescencia [...] atravesé una grandísima depresión [...] que me hizo muchas veces no ir al colegio, que me hacía no comer, que me hacía querer estar solo." (5:20-6:01)

La mención explícita de "depresión" como diagnóstico, junto con síntomas concretos, constituye una revelación de salud mental que excede significativamente los niveles habituales de exposición en el videoblog juvenil. Como señala @feixa2014, las generaciones digitales enfrentan formas específicas de precariedad y ansiedad vinculadas a la hiperconectividad y las demandas de autogestión identitaria en entornos de alta visibilidad.

![Performance de la vulnerabilidad: el youtuber como sujeto sensible que comparte sus angustias y fragilidades para construir un vínculo de autenticidad con su audiencia (Mariano Bondar, 2016).](capturas/cap05_c01_bondar_vulnerabilidad.png){#fig-bondar-vulnerabilidad fig-align="center" width="85%"}

::: {.content-visible when-format="html"}
[▶ Ver este momento en YouTube](https://youtu.be/0-nZidrR17w?si=3E5C77uE32fMv0C5&t=150){target="_blank"}
:::


#### El fracaso como parte del proceso

Un 22% de los videos tematizan fracasos, errores o dificultades de manera explícita. Algunos youtubers narran sus fracasos previos, videos que "no funcionaron" o momentos de desánimo, construyendo una imagen más compleja y realista de la trayectoria del creador digital. Esta representación opera en tres niveles: desmitificación del éxito instantáneo, valorización del proceso sobre el resultado, y construcción de resiliencia como valor juvenil. Al mostrar que el camino hacia la visibilidad digital incluye tropiezos, los youtubers construyen narrativas de autenticidad que los diferencian de las imágenes idealizadas del éxito que circulan en otros medios.

### Tensiones entre representaciones

El análisis revela que los youtubers no simplemente reproducen representaciones hegemónicas, sino que las negocian activamente. Identificamos tres tensiones centrales.

**Tensión global/local.** El 60% de los videos muestran elementos de "glocalidad" [@robertson1995], combinando formatos globales con contenido marcadamente local. Lucas Castel en "ESPECIAL DE HALLOWEEN" (VID 1) adopta un formato de YouTube ampliamente global, pero explicita inmediatamente las condiciones locales: "en Argentina la gente mayor no tiene idea de lo que es Halloween. Seguramente vos vas y tocas ahora un timbre y te esperan con un arma" (0:22-0:28). Los youtubers no ocultan esta tensión: la tematizan, la hacen visible, la convierten en contenido. Esta glocalidad refleja lo que @garciacanclini1989 conceptualizó como "culturas híbridas", donde lo global y lo local no se excluyen, sino que se entretejen.

**Tensión autenticidad/performance.** Todos los youtubers del corpus reivindican explícitamente su autenticidad ("yo soy así", "no tengo filtros") mientras ejecutan performances editadas, guionizadas y ajustadas a las lógicas algorítmicas de la plataforma. Los youtubers gestionan esta tensión mediante la exhibición selectiva del *backstage*: muestran "lo que no debería verse" —el cuarto desordenado, el momento vulnerable, el error técnico— como estrategia de autentificación, pero incluso ese *backstage* está cuidadosamente curado. La paradoja no es un defecto, sino el principio de funcionamiento: la autenticidad digital no es algo que se tiene o no se tiene, sino algo que se construye, se performa, se negocia constantemente.

**Tensión individual/comunitario.** Los youtubers construyen simultáneamente el yo único ("soy diferente", "no soy como los demás") y la pertenencia generacional ("los jóvenes somos así", "nos pasa a todos"). Esta doble articulación es constante: en un mismo video el youtuber puede reivindicar su singularidad absoluta y apelar a experiencias compartidas generacionalmente. Los youtubers exitosos son quienes logran ser simultáneamente "únicos como todos" y "como todos, pero únicos". Esta tensión refleja lo que @martinbarbero1998 denominó la dialéctica entre "individualización" y "comunidad" característica de las mediaciones tecnológicas contemporáneas.

Las identidades juveniles en los videoblogs no operan desde la coherencia o la estabilidad, sino desde la negociación permanente. Los youtubers no resuelven las tensiones: las administran, las convierten en contenido, las espectacularizan. Y en ese proceso configuran identidades que son simultáneamente auténticas y performadas, locales y globales, individuales y comunitarias. Identidades que, parafraseando a @bernete2007, habitan el "entre" como su territorio natural.

## Subjetividades juveniles: de la teoría a la operacionalización

Algunos antecedentes significativos han trazado el camino para este análisis. @campos2007 señala que los videoblogs funcionan como vehículos privilegiados para la expresión individual, aunque advierte la necesidad de abordarlos desde la formación de subculturas dentro del sistema de valores hegemónico. @chau2010 demuestra en qué medida YouTube provee una plataforma sociotécnica apta para mantener una cultura participativa entre sus usuarios. @julien2012 señala que los medios participativos han derribado las barreras tradicionales entre creadores y consumidores, facilitando el desarrollo de comunidades virtuales donde los creadores optan por "incluir" a su audiencia. Sin embargo, @banuelos2009 advierte que "YouTube reproduce las principales cualidades de la sociedad del espectáculo, basado en la estrategia de la 'autoproducción' limitada por la lógica de mercado y el plan de negocios del sitio" (p. 23), lo que implica que la agencia de los youtubers se despliega dentro de límites estructurales concretos.

Nuestra propuesta analítica recoge los rasgos de la identidad propuestos por @giddens1991 en un entrecruzamiento con las características del ciberdiscurso juvenil desarrolladas por @palazzo2010a. Las propiedades del proyecto narrativo del yo según Giddens —continuidad biográfica, reflexividad, gestión del cuerpo, relación con el otro— encuentran en el vlog formas idóneas de materialización. El proyecto narrativo se inicia desde el momento mismo en que se elige una tecnología considerada apta para enunciar el yo, y opera en presente continuo: interesa primordialmente quién se es hoy, con referencias menos sistemáticas al pasado biográfico o al futuro proyectado.
...
![Tabla 4. Articulación entre los rasgos de la identidad reflexiva (Giddens, 1991), las características del ciberdiscurso juvenil (Palazzo, 2010) y los marcadores discursivos identificados en el corpus de videoblogs (2012-2016).](imagenes/viz20_tabla_giddens.png){#fig-tabla-giddens fig-align="center" width="95%"}

::: {.content-visible when-format="html"}
::: {.callout-note collapse="true" icon="false"}
## 📊 Código fuente de esta visualización
Generado con [`viz_giddens_tabla.py`](scripts/viz_giddens_tabla.py) desde los datos del corpus.
:::
:::

### Repertorio de subjetividades disponibles
...
#### El joven reflexivo/intelectual
...
: Articulación entre subjetividades y representaciones sociales de juventud en el corpus. {#tbl-subj-repr}
...
Esta simultaneidad de lo local y lo global es lo que @robertson1995 denominó "glocalización". Nuestro Índice de Glocalidad operacionaliza esta dimensión midiendo el equilibrio entre elementos culturales que anclan al youtuber en coordenadas territoriales específicas versus elementos que lo proyectan hacia comunidades juveniles transnacionales. La escala va de -10 (máxima localización) a +10 (máxima globalización), con el 0 representando equilibrio. Las variables que suman hacia lo global (+) incluyen: glocalidad y referencias culturales mixtas (+1.5), vocabulario gamer/web (+1), léxico web general (+1), referencias a viajes y experiencias (+1), y exteriores de viajes (+1.5). Las variables que restan hacia lo local (-) incluyen: dialecto propio marcado (-2), lenguaje dialectal y léxico juvenil argentino (-1), referencia a jerga juvenil local (-1), cambio de variedad dialectal (-1), y espacios privados/domésticos argentinos (-0.5).

### Índice de Cercanía Parasocial (ICP)

"Hola Iutub, ¿cómo están? ¿Cómo estuvo su semana? La mía fue una locura, no van a creer lo que me pasó..." Así comienza Mica Suárez uno de sus videos, desplegando en quince segundos una batería completa de estrategias de construcción de cercanía: el vocativo colectivo, las preguntas directas, la promesa de compartir experiencia personal, el tono cálido y familiar.

El concepto de "interacción parasocial" fue introducido por Horton y @wohl1956 en un artículo seminal sobre las relaciones que las audiencias televisivas desarrollaban con personalidades mediáticas. Aunque la relación es objetivamente unidireccional (la audiencia ve al youtuber, pero el youtuber no ve a la audiencia), los espectadores desarrollan sentimientos de conocimiento íntimo y cercanía que se asemejan a relaciones interpersonales genuinas. Nuestro Índice de Cercanía Parasocial operacionaliza esta dimensión en una escala de 0 a 10. Las variables que suman incluyen: uso del pronombre "ustedes" (+1), uso del tuteo (+1), referencias a la comunidad (+1.5), menciones de YouTube como espacio compartido (+1), llamados a la acción (+1.5), mención de otras redes sociales (+1), y existencia de rasgos de *backstage* como nombres de pila, familiaridad y vida cotidiana (+0.5 cada uno).

### Índice de Modulación Pasional (IMP)

Todo enunciado tiene un contenido proposicional, y una "coloración" afectiva que modula cómo debe interpretarse ese contenido. Esta "coloración" es lo que la semiótica de las pasiones [@greimas1994] denomina modulación pasional. En el videoblog, esta dimensión adquiere complejidad especial porque los youtubers no solo dicen cosas, sino que las performan corporalmente ante la cámara: las emociones se exhiben mediante recursos multimodales que incluyen expresión facial, tono de voz, gestualidad corporal, edición de video y música de fondo.
...
### Índice de Autenticidad Performativa (IAP)
...
### Resultados generales del corpus
...
: Índices ponderados promedio por youtuber. IGL puede ser negativo (orientación local). Fuente: Elaboración propia a partir de `MATRIZ_FINAL_RESTAURADA.csv`. {#tbl-indices-youtuber}
...
![Índices ponderados promedio por youtuber. Escala de color relativa por índice (azul=valor mínimo del corpus, rojo=valor máximo). IGL puede ser negativo (orientación predominantemente local).](imagenes/viz21_tabla_indices.png){#fig-tabla-indices fig-align="center" width="95%"}
...
El dormitorio opera como el marcador de intimidad por excelencia. Al grabar desde su cuarto, el youtuber invita simbólicamente a la audiencia a ingresar en su espacio más íntimo, construyendo una ilusión de proximidad, una especie de *extimidad* materializada [@sibilia2008]. Los espacios exteriores y públicos significan aventura, libertad, exploración. El 30% de los videos incluyen cambios de escenario dentro del mismo video, construyendo dinamismo y agencia. Lucas Castel narra explícitamente este movimiento en VID 1: "Hoy estamos en la calle, en vez de filmar en mi casa como hacíamos antes." El contraste entre el "antes" doméstico y el "ahora" exterior narra una evolución, un crecimiento.
...
### Combinaciones y modulaciones subjetivas
...
## Análisis multimodal de seis videos paradigmáticos
...
### Lucas Castel, "50 COSAS SOBRE MÍ" (VID 5): la intimidad calibrada
...
### Julián Serrano, "Draw My Life" (VID 13): la biografía espectacularizada
...
### Mariano Bondar, "COMO SUPERÉ LA MUERTE DE MI AMIGO" (VID 50): el límite de la *extimidad*
...
### Mica Suárez, "50 COSAS SOBRE MÍ" (VID 74): la autenticidad femenina
...
### Gonzalo Goette, "BESANDO MUJERES FRENTE A SUS NOVIOS" (VID 52): la autenticidad por riesgo
...
### Lionel Ferro, "LES PRESENTO AL AMOR DE MI VIDA" (VID 33): la autenticidad profesionalizada
...
## Perfiles identitarios por youtuber
